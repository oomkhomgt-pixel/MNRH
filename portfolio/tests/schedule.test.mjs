...
export default async function run() {
  ...
  try {
    ...
    /* ---------- หน้าประเมิน: งานนำเสนอ · ลงกองสิ้นเดือน · ท้ายเซสชัน ---------- */
    {
      ...
      /* หน้าที่สาม "ต้องตามต่อ" รวมผลที่แปลว่ายังไม่จบ (นำเสนอซ้ำ / ติดตามเป็นพิเศษ) ซึ่งเดิมหลุดจากทุกคิว */
      t.eq("หน้าประเมินมีสามหน้าย่อย — งานนำเสนอ · ลงกองสิ้นเดือน · ต้องตามต่อ", pages.pages, ["talks", "month", "follow"]);
