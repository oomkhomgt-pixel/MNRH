...
| การแสดงผล | ตารางและหน้า "วันนี้" ขึ้นว่า **"นพ. ก (แทน นพ. ข)"** ไม่ใช่เปลี่ยนชื่อเงียบ ๆ |
| ผลประเมิน | ไม่ถูกย้าย — รหัสคาบ (`key`) ไม่มีชื่ออาจารย์อยู่ในนั้น การแลกจึงเปลี่ยนแค่ชื่อผู้รับผิดชอบ ไม่ได้เปลี่ยนตัวคาบ |
| แลกกลับ | ใส่วันที่แลกกลับแล้วระบบสร้างอีกฝั่งให้เอง จึงเป็นการ **แลก** ไม่ใช่การ **ฝาก** ถ้าไม่ใส่ จะขึ้นป้ายว่ายังไม่ได้แลกกลับ |
| กันชนกัน | ถ้าคนที่มารับแทนมีคาบอื่นในวันนั้นอยู่แล้ว ระบบเตือนทันทีที่เลือกชื่อ และถามยืนยันก่อนบันทึก |
| สิทธิ์ | อาจารย์บันทึกได้เฉพาะคาบของตัวเอง · ผู้จัดหลักสูตรบันทึกได้ทุกคาบ · แพทย์ประจำบ้านบันทึกไม่ได้เลย |

บันทึกได้สามทาง: ปุ่ม **+ บันทึกการแลกวัน** ที่การ์ด "การแลกวัน OR ของอาจารย์" ในหน้าตาราง ·
ปุ่ม **แลกวันนี้ให้คนอื่น** บนการ์ดคาบของตัวเองในหน้า "วันนี้" · หรือเปิดคาบนั้นในปฏิทินแล้วกดจากในกล่อง
