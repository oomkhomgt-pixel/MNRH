...
- **คาบของอาจารย์ล้วน** ติดธง `staffOnly` ไว้ได้ — อยู่ในตารางเป็นบันทึก แต่ไม่สร้างคาบให้แพทย์ประจำบ้าน
  (คลินิกพิเศษออร์โธเด็กบ่ายพฤหัสบดีเป็นแบบนี้)
...
- **เวร ER ในเวลาราชการตกกับคนเดียว ไม่ใช่ทั้งสาย** — คนที่ชั้นปีน้อยที่สุดของสายนั้น standby ที่ ER
  และรับ consult จากนอกแผนก ที่เหลือในสายเข้า OR emergency ตามตารางประจำสัปดาห์ตามปกติ
  ระบุตัวเองได้ที่ช่อง “ผู้ standby ER” ถ้าเว้นว่างระบบจะเลือกคนที่ชั้นปีน้อยที่สุดให้
- คาบ standby ER มีลำดับความสำคัญ 25 สูงกว่าสาย จึงชนะห้องผ่าตัดของคนคนนั้นในวันนั้น
