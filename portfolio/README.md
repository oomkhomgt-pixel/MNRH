...
**ใช้โลโก้จริงของกลุ่มงาน ไม่ได้วาดใหม่** — `portfolio/logo-tree.png` คือเครื่องหมายต้นไม้ที่ตัดพื้นออกจากไฟล์โลโก้
สีและรูปทรงทุกจุดเป็นของเดิม

โครงเดียวกับไอคอนของระบบคิวห้องผ่าตัด: **โลโก้ด้านบน ป้ายชื่อล่างกลาง**
ต่างกันตรงที่ป้ายของแฟ้มสะสมงานอยู่ใน **แถบทึบสีน้ำเงินเขียว** ส่วนของระบบคิวเป็นข้อความเปล่า

| แอป | ป้ายล่าง |
|---|---|
| แฟ้มสะสมงาน (แอปนี้) | “แฟ้ม” ในแถบทึบ |
| ระบบคิวห้องผ่าตัด | “OR System” เป็นข้อความเปล่า |

เหตุผลที่ต้องมีแถบ ไม่ใช่แค่เปลี่ยนคำ: **ที่ 48px ตัวอักษรอ่านไม่ออกแล้วทั้งคู่**
ถ้าต่างกันแค่คำ สองไอคอนจะกลายเป็นรอยเปื้อนเล็ก ๆ ใต้ต้นไม้เหมือนกัน แยกไม่ออก
แถบทึบเป็นสิ่งเดียวที่ยังเห็นได้ทุกขนาด และคำไทยสั้นอ่านออกได้ต่ำกว่าคำอังกฤษยาว

สร้างไฟล์ใหม่ด้วย

```bash
node portfolio/docs/make-icons.mjs      # ต้องมี playwright
```

สคริปต์สร้างครบทั้งสี่ใบจาก `logo-tree.png` — เปลี่ยนคำบนป้ายได้ที่ตัวแปร `LABEL` ในสคริปต์
`icon-maskable-512.png` ย่อทั้งก้อนเข้ามา 13% ให้ทั้งต้นไม้และแถบรอดจากการครอปเป็นวงกลมและ squircle ของ Android
