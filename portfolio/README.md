...
- **คาบส่วนกลางจำกัดชั้นปีได้** (เช่น basic science เฉพาะปี 1) และเลือกได้ว่าคนที่วนนอกภาควิชาต้องเข้าด้วยหรือไม่
...
- คาบ **อยู่เวร ER** มีลำดับความสำคัญ 25 สูงกว่าสาย จึงชนะห้องผ่าตัดของสายในวันนั้น —
  คนอยู่เวรไม่ต้องไปเข้า list ตามตารางสาย
