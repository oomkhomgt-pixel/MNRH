...
ใช้ต้นไม้จากโลโก้ของกลุ่มงาน ต้นฉบับอยู่ที่ `portfolio/icon.svg`
**สีตาม CI ทุกจุด** — ส้ม `#F5901A` บนพื้นขาว ไม่มีสีอื่นเพิ่ม

ต่างจากโลโก้บนหัวจดหมายอย่างเดียวคือ **วงกลมทึบแทนวงแหวน** เพราะวงแหวนบางเกินไป
พอย่อเหลือ 48px บนหน้าจอโฮมแล้วรูตรงกลางตัน กลายเป็นก้อนเบลอ —
การทำฉบับทึบไว้ใช้ขนาดเล็กเป็นเรื่องปกติของงานออกแบบเครื่องหมาย
**โลโก้ฉบับวงแหวนยังเป็นตัวจริงสำหรับเอกสารและงานพิมพ์ทุกชิ้น**

**แยกจากระบบคิวห้องผ่าตัดด้วยโครงสร้าง ไม่ใช่ด้วยสี**

| แอป | วงกลม |
|---|---|
| แฟ้มสะสมงาน (แอปนี้) | ทึบ |
| ระบบคิวห้องผ่าตัด (ข้อเสนอ) | วงแหวน ตาม CI เดิม |

ข้อจำกัดที่ต้องรู้: เมื่อสีเหมือนกันทั้งคู่ ความต่างจึงอยู่ที่ความหนักเบาของรูปเท่านั้น
ที่ 192px ขึ้นไปแยกออกชัด แต่ที่ 48px ฉบับวงแหวนจะเริ่มตัน ทำให้สองไอคอนใกล้เคียงกันขึ้น
ถ้าต้องการให้แยกออกทันทีทุกขนาด ต้องยอมให้ฉบับใดฉบับหนึ่งใช้พื้นสีเข้ม (reversed) ซึ่ง CI ส่วนใหญ่อนุญาต

ไฟล์ PNG ทั้งสี่ใบเรนเดอร์จาก `icon.svg` — แก้ที่ SVG แล้วเรนเดอร์ใหม่ อย่าแก้ PNG โดยตรง
`icon-maskable-512.png` ย่อเครื่องหมายเหลือ 64% ให้อยู่ในวงปลอดภัยของ Android ที่ครอปเป็นวงกลมหรือ squircle
