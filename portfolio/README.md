...
ข้อยกเว้นคือวันที่คนในสายไม่พอ ซึ่งเป็นคนละเรื่องกับการแลกวัน และบันทึกด้วย
**การเข้าคาบรายวัน** (`sessionPicks`) เป็นราย ๆ ไป — วันนั้นคนนั้นเข้าคาบไหน กับอาจารย์คนใด

### ขอไปเข้าคาบของสายอื่น

บางครั้งมีเหตุผลเฉพาะที่ทำให้ควรไปเข้าคาบของอาจารย์สายอื่น — เคสที่เกี่ยวกับงานวิจัยที่ทำอยู่
เคสที่หาดูยาก หรือตามเก็บหัตถการที่ยังขาดตามเกณฑ์ — **แต่ต้องได้รับอนุมัติก่อน ไม่ใช่ไปเองแล้วค่อยบอก**
...
| เหตุผล | เลือกจากรายการ (งานวิจัย · เคสที่หาดูยาก · ตามเก็บหัตถการ · อื่น ๆ) “อื่น ๆ” ต้องระบุรายละเอียด |
