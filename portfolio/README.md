...
- **ข้อจำกัดที่ต้องรู้ตอนนี้**: การส่งขึ้นคลาวด์เป็นการเขียนทับทั้งชุด (last write wins) ถ้ามีคนแก้พร้อมกันหลายเครื่อง
  ของที่ส่งทีหลังจะทับของก่อนหน้า จึงควรให้เครื่องของผู้จัดหลักสูตรเป็นเจ้าของการแก้ทะเบียนและตาราง
  ส่วนการรวมข้อมูลรายรายการ (merge) ต้องทำที่ฝั่งเซิร์ฟเวอร์เมื่อพัฒนาของจริง
