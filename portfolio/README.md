...
- **ปี 4 เป็นกำลังเสริม** — ปกติลงหน่วยอนุสาขา แต่ถ้าสายใดไม่มีคนหรือไม่มีรุ่นพี่ ระบบจะดึงปี 4 มาลงสายนั้น
  โดยจำกัดไม่เกิน 3 เดือนต่อคน เพื่อไม่ให้เสียเวลาวนหน่วยอนุสาขาไป (แก้ค่าได้ที่ `R4_MAX_TEAM_MONTHS`)
