...
| **สายที่ยังสังกัด** | คนที่วนหน่วยอนุสาขาแต่ยังอยู่สาย (ตั้งที่ช่องหน่วยรองของช่วงหมุนเวียน) | ward round ของสายเดิม |
...
- ตัดสินด้วย **ลำดับความสำคัญ** ตั้งได้ที่หน้าตั้งค่า ค่าเริ่มต้น ส่วนกลาง 30 · หน่วยอนุสาขา 20 · สาย 10
...
- **การเลือกรายวันชนะลำดับความสำคัญเสมอ** และมีผลเฉพาะวันนั้น ไม่กระทบสัปดาห์อื่น
