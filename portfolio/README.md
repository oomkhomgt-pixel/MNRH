...
ใช้ต้นไม้จากโลโก้ของกลุ่มงาน วาดใหม่เป็นเรขาคณิตสะอาดที่ `portfolio/icon.svg`
น้ำหนักเส้นหนากว่าโลโก้บนหัวจดหมาย เพราะไอคอนต้องอ่านออกที่ 36–48px บนหน้าจอโฮม ไม่ใช่บนกระดาษ A4
สีมาจากโลโก้จริง — ส้ม `#F5901A` · น้ำเงินเขียวเข้ม `#0A5570`

**แยกจากระบบคิวห้องผ่าตัดด้วยพื้น ไม่ใช่ด้วยรูป** — สองแอปเป็นของกลุ่มงานเดียวกัน จึงควรใช้เครื่องหมายเดียวกัน
สิ่งที่ต้องต่างคือสิ่งที่ตาจับได้ก่อนที่คนจะทันอ่านชื่อ:

| แอป | พื้น | ต้นไม้ |
|---|---|---|
| แฟ้มสะสมงาน (แอปนี้) | น้ำเงินเขียวเข้ม | ส้ม |
| ระบบคิวห้องผ่าตัด (ข้อเสนอ) | ส้ม | ขาว |

ไฟล์ PNG ทั้งสี่ใบเรนเดอร์จาก `icon.svg` — แก้ที่ SVG แล้วเรนเดอร์ใหม่ อย่าแก้ PNG โดยตรง
`icon-maskable-512.png` ย่อเครื่องหมายเหลือ 62% ให้อยู่ในวงปลอดภัยของ Android ที่ครอปไอคอนเป็นวงกลมหรือ squircle
